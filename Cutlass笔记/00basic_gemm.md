...
// 关键头文件，Defines cutlass::gemm::device::Gemm, the generic Gemm computation template class.
...
cudaError_t CutlassSgemmNN(
    ...
    // 构造参数对象
    // 所有参数都在主机端构造好，可以在主机端做合法性检查、资源分配等操作
    // 构造好的参数对象整体复制进设备端，避免设备端初始化大量结构体
    // 方便扩展复用
...
总结一下实现一个最基本的cutlass gemm包含下面步骤
